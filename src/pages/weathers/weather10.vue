...
defineOptions({ name: 'Weather10Page' })
...
<template>
  <div class="min-h-[100dvh] bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50">
    ...
    <div class="pointer-events-none relative z-20 mx-auto max-w-3xl px-5 pt-28 pb-24">
      <!-- Header -->
      <header class="mb-10">
        <p
      ...
      <!-- Stats grid -->
      <div class="pointer-events-auto mb-8 grid grid-cols-3 gap-3">
        <!-- Avg temp: large -->
      ...
      <!-- Controls row -->
      <div class="pointer-events-auto mb-6 flex flex-wrap items-center gap-3">
        <!-- Search -->
      ...
      <!-- City list -->
      <div v-else class="pointer-events-auto space-y-2">
        <!-- Empty state -->
        <div
