  ...
  <div class="min-h-[100dvh] bg-white pt-24 pb-24 dark:bg-zinc-950">
    <div class="mx-auto max-w-2xl px-6">
      ...
      <div class="mt-6 grid grid-cols-3 gap-3">
        <div
          class="rounded-xl border border-zinc-100 bg-zinc-50 p-4 text-center dark:border-zinc-800 dark:bg-zinc-900"
        >
      ...
      <BaseDashboardCard class="mt-4">
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <span
              class="ml-auto rounded-full bg-zinc-200 px-3 py-0.5 text-xs text-zinc-600 dark:bg-zinc-700 dark:text-zinc-300"
              >{{ city.status }}</span
            >
            <!-- v-bind 즐겨찾기 아이콘 -->
            <button
